...
public class NearbyRecyclerViewAdapter extends RecyclerView.Adapter<NearbyRecyclerViewAdapter.NearbyViewHolder> {
    ...
    // you provide access to all the views for a data item in a view vhBinder
...
//        vhBinder.nearbyNameImage.setImageDrawable(nameDrawable);
//        vhBinder.nearbyNameImage.setVisibility(View.VISIBLE);
    }
